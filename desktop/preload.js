...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  activateNavidromeProfile: (profileId) => ipcRenderer.invoke('mineradio-navidrome-activate-profile', String(profileId || '')),
  deleteNavidromeProfile: (profileId) => ipcRenderer.invoke('mineradio-navidrome-delete-profile', String(profileId || '')),
  testNavidromeProfile: (payload) => ipcRenderer.invoke('mineradio-navidrome-test-profile', payload || {}),
  chooseLocalLibraryRoots: () => ipcRenderer.invoke('mineradio-local-library-choose-roots'),
  rescanLocalLibrary: (force) => ipcRenderer.invoke('mineradio-local-library-rescan', !!force),
